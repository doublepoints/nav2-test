...
def generate_launch_description():
    ...
    # 8. Navigation configuration for real robot
    nav2_config_file = os.path.join(pkg_project_bringup, 'config', 'robot_nav2_params.yaml')
    ...
    velocity_smoother = Node(
        ...
        output='screen',
        parameters=[nav2_config_file],
        remappings=[('/cmd_vel_smoothed', '/g1/cmd_vel')]
    )
    ...
    rviz2_node = Node(
        ...
        name='rviz2',
        arguments=[
            '-d', os.path.join(pkg_project_bringup, 'config', 'robot_navigation.rviz'),
